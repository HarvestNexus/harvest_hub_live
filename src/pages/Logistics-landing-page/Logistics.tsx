...
export  const Logistics:React.FC = ()=>{
    ...
    {id: 1, img: "./images/l-img1.avif", title: "Steady Delivery Requests", desc: "Get consistent jobs from farmers and buyers." },
    {id: 2, img: "./images/l-img2.avif", title: "Timely Payments", desc: "Secure, fast payments for every completed delivery." },
    {id: 3, img: "./images/l-img3.avif", title: "Nationwide Reach", desc: "Expand your delivery network beyond your current location." },
  ]
  ...
  const SVG = ()=>(
	...
	return (
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('./images/l-hero.avif')`
...
<div className="absolute top-0 z-10 sticky">
      ...
      <div className="relative text-white px-4 gap-4 py-3 ">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold font-bold">
          Grow Your Logistics <br className="sm:hidden"/> Business with Us
        </h1>
...
<span className="text-brand-dark font-semibold font-nunito  md:text-xl">Key Benefits</span>
    ...
    <section>
      <div className="flex flex-col gap-4 items-center">
        <div className="relative flex gap-2 items-center justify-center bg-brand-fadeGreen text-brand-dark font-semibold w-fit mx-auto px-2 py-3 rounded-3xl">
          <SVG /><span className="text-secondary-700 font-nunito text md:text-xl">FAQs</span>
        </div>
        <h2 className="text-center text-3xl text-nunito max-w-sm">Got Questions? <br /> We’ve Got Answers</h2>
        <p className="md:text-xl text-[#646464] text-center max-w-xl text-nunito">Clear answers to help you get started with delivery and earning.</p>
      </div>
      {/*Accordio*/}
      <FAQ />
    </section>
    <section className="relative flex items-center justify-center mx-auto bg-brand-fadeGreen  md:h-[25rem] ">
